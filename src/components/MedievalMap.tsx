...
// Closed Bezier curve tracing the painted Athonite peninsula. Drawn so the
// projected coordinates of every monastery, skete and hermitage in our data
// fall comfortably on the painted land (the projection is not faithful to
// real-world cartography — it is shaped to fit the icons).
const PENINSULA_PATH = `
  M 240 220
  C 200 160, 290 110, 400 130
  C 480 145, 540 130, 600 150
  C 660 175, 720 205, 790 260
  C 855 320, 880 380, 910 430
  C 945 480, 985 525, 1045 570
  C 1100 595, 1145 625, 1175 665
  C 1195 695, 1175 725, 1135 735
  C 1095 745, 1050 742, 990 732
  C 940 722, 905 707, 865 697
  C 825 685, 795 692, 765 672
  C 725 642, 690 605, 650 565
  C 610 520, 570 472, 530 428
  C 490 388, 450 348, 410 316
  C 370 286, 330 268, 300 252
  C 275 237, 250 226, 240 220
  Z
`.trim();
